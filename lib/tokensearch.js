 ...
 */
Tokensearch.prototype.search = function(token) {
  var self = this;
  var searchTokens = [];
  ...
  this.collection.forEach(function(entry) {
    var score = 0;
    entry[self.collectionKey].split(self.delimiter).forEach(function(data) {
